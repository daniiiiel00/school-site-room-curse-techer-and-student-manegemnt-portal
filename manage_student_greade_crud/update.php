...
if (isset($_GET['id'])) {
    $id = intval($_GET['id']);
    $result = $conn->query("SELECT * FROM students_mark WHERE id=$id");
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $conn->query("UPDATE students_mark SET f_name='$f_name', grade='$grade', section='$section', mark='$mark' WHERE id=$id");
...
<div class="form-container">
    <form method="post">
        ...
        <label>Mark:</label>
        <input type="text" name="mark" value="<?= htmlspecialchars($row['mark']) ?>" required>
